...
<div className="sc-user-input--picker-wrapper">
  {tooltip}
  <button className="sc-user-input--emoji-icon-wrapper" onClick={onClick}>
    <svg
    ...
    >
      <g>
        <path d="M18.696,37C8.387,37,0,29.006,0,18.696C0,8.387,8.387,0,18.696,0c10.31,0,18.696,8.387,18.696,18.696
          C37,29.006,29.006,37,18.696,37z M18.696,2C9.49,2,2,9.49,2,18.696c0,9.206,7.49,16.696,16.696,16.696
